...
namespace WebQuanLyQuanTraSua.Controllers
{
    public class KHUYENMAIsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKM,TenKM,DieuKienCapBac,GhiChu")] KHUYENMAI kHUYENMAI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKM,TenKM,DieuKienCapBac,GhiChu")] KHUYENMAI kHUYENMAI)
        {
            if (ModelState.IsValid)
            {
